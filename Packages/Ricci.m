...
*                                                                         *
*                Copyright (c) 1992 - 2022 John M. Lee                    *
*                        All rights reserved                              *
*                                                                         *
...
Print[" -- Ricci Version 1.63 (May 29, 2022) --"];
Print["    Copyright 1992 - 2022 John M. Lee"];
...
DeclareConstant[ c_, opts___ ] := Module[{type},
  If[MemberQ[optionNames[{opts}], Type],
    ...
    If [ $VersionNumber >= 12.2,
        (*then*)
      If[ ValueQ[Sign[c],Method->"TrialEvaluation"],        c/: Sign[c]        =.];
      If[ ValueQ[Positive[c],Method->"TrialEvaluation"],    c/: Positive[c]    =.];
      If[ ValueQ[NonNegative[c],Method->"TrialEvaluation"], c/: NonNegative[c] =.];
      If[ ValueQ[NonPositive[c],Method->"TrialEvaluation"], c/: NonPositive[c] =.];
      If[ ValueQ[Negative[c],Method->"TrialEvaluation"],    c/: Negative[c]    =.];
      If[ ValueQ[Conjugate[c],Method->"TrialEvaluation"],   c/: Conjugate[c]   =.],
       (*else*)
...
Inverse/: Tensor[Inverse[x_], {i_,j_}, {}] := 
  Inverse[x] [i,j] /; 
     If [ $VersionNumber >= 12.2,
     ValueQ[Inverse[x],Method->"TrialEvaluation"],
     ValueQ[Inverse[x]]];
